...
import { 
  ...
  BrainCircuit, TrendingUp, AlertTriangle, UsersRound, 
...
const AdminLayout = ({ children }) => {
  ...
  const navItems = [
    ...
    { name: 'AI Smart Insights', path: '/admin/insights', icon: BrainCircuit },
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `flex flex-col items-center p-2 rounded-lg text-[10px] font-medium transition-colors ${
                isActive ? 'text-forest-700 bg-forest-50' : 'text-earth-500 hover:text-forest-600'
              }`
            }
          >
            {({ isActive }) => (
