  ...
  return (
    <div className="space-y-6 font-sans">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <p className="text-[11px] font-extrabold text-slate-400 uppercase tracking-widest">{t('centre.nav.dashboard', 'DASHBOARD')}</p>
        ...
        <div className="flex items-center gap-3.5 bg-white px-4 py-2.5 rounded-2xl border border-slate-200/90 shadow-xs">
          ...
          <div className={`w-9 h-9 rounded-full flex items-center justify-center shrink-0 transition-colors ${centreOpen ? 'bg-emerald-100/70' : 'bg-slate-100'}`}>
            <span className={`w-3.5 h-3.5 rounded-full transition-colors ${centreOpen ? 'bg-[#046a38]' : 'bg-slate-400'}`}></span>
          </div>
          
          {/* Middle Labels */}
          <div className="flex flex-col justify-center pr-2">
            <span className="text-[11px] font-semibold text-slate-500 leading-tight">{t('centre.centreStatus', 'Centre Status')}</span>
            <span className={`text-sm font-black tracking-tight leading-tight mt-0.5 ${centreOpen ? 'text-[#046a38]' : 'text-slate-500'}`}>
          ...
          <button 
            ...
            className={`relative inline-flex h-7 w-12 items-center rounded-full transition-colors p-0.5 cursor-pointer ${centreOpen ? 'bg-[#046a38]' : 'bg-slate-300'}`}
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card className="border border-slate-100 shadow-xs bg-white rounded-2xl overflow-hidden hover:shadow-md transition-shadow">
          <CardContent className="p-5 flex items-center justify-between">
            <div className="flex items-center gap-3.5">
              {/* COLOURED ICON CONTAINER LIKE REFERRAL */}
              <div className="w-12 h-12 rounded-2xl bg-[#e6f4ea] flex items-center justify-center shrink-0">
                <div className="w-8.5 h-8.5 rounded-xl bg-[#046a38] text-white flex items-center justify-center shadow-xs">
              ...
              <div>
                ...
                <div className="flex items-baseline gap-2 mt-0.5">
                  <span className="text-2xl md:text-3xl font-black text-slate-900">{todaysBookings}</span>
                  <span className="px-2 py-0.5 rounded-full text-[11px] font-bold bg-[#e6f4ea] text-[#046a38] flex items-center gap-0.5">
                    <TrendingUp className="w-3 h-3" /> 12%
                  </span>
                </div>
                <p className="text-xs font-medium text-slate-400 mt-1">{pendingArrivals} pending arrivals</p>
              </div>
            </div>
            <button 
              onClick={() => navigate('/centre/bookings')}
              className="w-8 h-8 rounded-full border border-slate-200 flex items-center justify-center text-slate-400 hover:border-[#046a38] hover:text-[#046a38] transition-colors shrink-0 ml-2 cursor-pointer"
            >
        ...
        <Card className="border border-slate-100 shadow-xs bg-white rounded-2xl overflow-hidden hover:shadow-md transition-shadow">
          <CardContent className="p-5 flex items-center justify-between">
            <div className="flex items-center gap-3.5">
              ...
              <div>
                <p className="text-xs font-bold text-slate-600">Waiting Farmers</p>
                <div className="flex items-baseline gap-2 mt-0.5">
                  <span className="text-2xl md:text-3xl font-black text-slate-900">{waitingFarmers}</span>
                  <span className="px-2 py-0.5 rounded-full text-[11px] font-bold bg-[#e6f4ea] text-[#046a38] flex items-center gap-0.5">
                    <TrendingDown className="w-3 h-3" /> 50%
                  </span>
                </div>
                <p className="text-xs font-medium text-slate-400 mt-1">~34 min avg wait</p>
              </div>
            </div>
            <button 
          ...
          <CardContent className="p-5 flex items-center justify-between">
            <div className="flex items-center gap-3.5">
              ...
              <div>
                ...
                <div className="flex items-baseline gap-2 mt-0.5">
                  <span className="text-2xl md:text-3xl font-black text-slate-900">{completedTodayCount}</span>
                </div>
                <p className="text-xs font-medium text-slate-400 mt-1">Procurements today</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="border border-slate-100 shadow-xs bg-white rounded-2xl overflow-hidden">
          <CardContent className="p-5 flex items-center justify-between">
            <div className="flex items-center gap-3.5">
              ...
              <div>
                <p className="text-xs font-bold text-slate-600">Active Counters</p>
                <div className="flex items-baseline gap-2 mt-0.5">
                  <span className="text-2xl md:text-3xl font-black text-slate-900">{activeCountersCount} / {totalCountersCount}</span>
                </div>
                <p className="text-xs font-medium text-slate-400 mt-1">{operationalPct}% operational</p>
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      <div>
        ...
        <p className="text-xs font-medium text-slate-500 mt-0.5">Get started with common tasks.</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-3">
          ...
          >
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-[#e6f4ea] flex items-center justify-center shrink-0">
                <div className="w-7 h-7 rounded-lg bg-[#046a38] text-white flex items-center justify-center shadow-xs">
                  <Users className="w-4 h-4 text-white" strokeWidth={2.5} />
                </div>
              </div>
              <div>
                <span className="font-bold text-slate-900 text-sm block leading-tight">Live Queue</span>
                <span className="text-[10px] font-semibold text-[#046a38] block mt-0.5">Queue & Verification</span>
              </div>
            </div>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className="font-bold text-slate-900 text-sm">Today's Bookings</span>
            </div>
            <ChevronRight className="w-4 h-4 text-slate-400 group-hover:text-[#046a38] group-hover:translate-x-0.5 transition-all" />
          </div>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className="font-bold text-slate-900 text-sm">Procurement</span>
            </div>
            <ChevronRight className="w-4 h-4 text-slate-400 group-hover:text-[#046a38] group-hover:translate-x-0.5 transition-all" />
          </div>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className="font-bold text-slate-900 text-sm">Payments</span>
            </div>
            <ChevronRight className="w-4 h-4 text-slate-400 group-hover:text-[#046a38] group-hover:translate-x-0.5 transition-all" />
          </div>
        ...
        <div className="lg:col-span-7 bg-white rounded-2xl border border-slate-100 p-6 shadow-xs">
          <div className="flex items-center justify-between pb-4 mb-4 border-b border-slate-100">
            ...
            <button 
              ...
              className="text-xs font-bold text-[#046a38] hover:underline flex items-center gap-1 cursor-pointer"
            >
          ...
          <div className="space-y-3">
            {recentActivities.map((act, index) => (
              <div key={index} className="flex items-center justify-between py-2.5 px-3 rounded-xl border border-slate-100 hover:bg-slate-50/70 transition-colors">
                <div className="flex items-center gap-3">
                  <span className="text-xs font-medium text-slate-400 w-16">{act.time}</span>
                  <span className={`w-2.5 h-2.5 rounded-full ${act.dotColor}`}></span>
                  <span className="text-xs md:text-sm font-semibold text-slate-800">{act.action}</span>
                </div>
                <span className="text-xs font-medium text-slate-500">{act.detail}</span>
              </div>
            ))}
          </div>
        </div>
          ...
          <div>
            <div className="flex items-center justify-between pb-4 mb-4 border-b border-slate-100">
              <div className="flex items-center gap-2.5">
                ...
                <h3 className="font-bold text-slate-900 text-base">Centre Overview</h3>
              </div>
              <span className="px-2.5 py-0.5 rounded-full text-xs font-extrabold bg-[#e6f4ea] text-[#046a38] border border-emerald-200">
                C001
              </span>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3 py-1">
                <div className="w-8 h-8 rounded-lg bg-[#e6f4ea] flex items-center justify-center shrink-0 mt-0.5">
                  <MapPin className="w-4 h-4 text-[#046a38]" strokeWidth={2.5} />
                </div>
                <div>
                  <p className="font-bold text-slate-900 text-sm">Sri Lakshmi Procurement Centre</p>
                  <p className="text-xs font-medium text-slate-500 mt-0.5">Andhra Pradesh</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 py-2 border-t border-slate-100">
                <div className="w-8 h-8 rounded-lg bg-[#e6f4ea] flex items-center justify-center shrink-0">
                  <Clock className="w-4 h-4 text-[#046a38]" strokeWidth={2.5} />
                </div>
                <div className="flex justify-between items-center w-full">
                  <span className="text-xs font-semibold text-slate-600">Centre Timings</span>
                  <span className="text-xs font-bold text-slate-900">8:00 AM – 6:00 PM</span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 py-2 border-t border-slate-100">
                ...
                <div className="flex justify-between items-center w-full">
                  <span className="text-xs font-semibold text-slate-600">Total Counters</span>
              ...
              <div className="flex items-center gap-3 py-2 border-t border-slate-100">
                <div className="w-8 h-8 rounded-lg bg-[#e6f4ea] flex items-center justify-center shrink-0">
                  <Package className="w-4 h-4 text-[#046a38]" strokeWidth={2.5} />
                </div>
                <div className="flex justify-between items-center w-full">
                  <span className="text-xs font-semibold text-slate-600">Commodities</span>
                  <span className="text-xs font-bold text-slate-900">Paddy, Maize</span>
                </div>
              </div>
            </div>
          </div>
