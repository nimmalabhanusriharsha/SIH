      ...
      <div className="w-full max-w-lg">
        ...
        <div className={`bg-white border shadow-sm rounded-3xl overflow-hidden ${isFarmer ? 'border-farmer-border shadow-farmer-card' : 'border-earth-200'}`}>
          ...
          <div className="p-6 pt-2">
            ...
            {error && (
              <div className={`p-3 rounded-xl text-xs font-bold border mb-4 animate-in fade-in ${
                isFarmer 
            ...
            {successMsg && (
              <div className={`p-3 rounded-xl text-xs font-bold border mb-4 animate-in fade-in flex items-center gap-1.5 ${
                isFarmer 
            ...
            {(!isFarmer || tabMode === 'login') && (
              <form onSubmit={handleLogin} className="space-y-4">
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full min-h-[48px] rounded-2xl border px-4 text-sm font-bold focus:outline-none ${
                        isFarmer 
                ...
                <button 
                  type="submit" 
                  className={`w-full min-h-[50px] font-bold text-sm rounded-2xl shadow-sm flex items-center justify-center gap-2 transition-colors ${
                    isFarmer 
